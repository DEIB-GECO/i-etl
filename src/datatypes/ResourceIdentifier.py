...
class ResourceIdentifier(Identifier):
    def __init__(self, id_value: str, resource_type: str):
        if resource_type is None:
            ...
            resource_id = resource_type + DELIMITER_RESOURCE_ID + id_value
    ...
    def get_int_id(self):
        ...
        split_resource_id = self.value.split(DELIMITER_RESOURCE_ID)
    ...
    def get_type(cls, identifier: str):
        split_resource_id = identifier.split(DELIMITER_RESOURCE_ID)
        return split_resource_id[0]  # resource_id_part[1] is the int id
