...
class GenomicRecord(Record):
    def __init__(self, id_value: str, value: Any, anonymized_value: Any, uri: str, patient_id: Identifier, hospital_id: Identifier,
        ...
        super().__init__(id_value=id_value, feature_id=feature_id, patient_id=patient_id, hospital_id=hospital_id,
                         value=value, anonymized_value=anonymized_value, resource_type=TableNames.GENOMIC_RECORD, counter=counter, hospital_name=hospital_name)
