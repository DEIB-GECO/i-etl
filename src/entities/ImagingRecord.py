...
class ImagingRecord(Record):
    def __init__(self, id_value: str, value: Any, scan: str, patient_id: Identifier, hospital_id: Identifier,
        ...
        super().__init__(id_value=id_value, feature_id=feature_id, patient_id=patient_id, hospital_id=hospital_id,
                         value=value, resource_type=TableNames.IMAGING_RECORD, counter=counter,
