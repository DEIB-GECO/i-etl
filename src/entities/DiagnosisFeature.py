...
class DiagnosisFeature(Feature):
    def __init__(self, id_value: str, original_name: str, ontology_resource: OntologyResource, permitted_datatype: str, dimension: str | None,
        ...
        super().__init__(id_value=id_value, original_name=original_name, resource_type=TableNames.DIAGNOSIS_FEATURE, ontology_resource=ontology_resource,
