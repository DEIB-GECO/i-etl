...
class LabFeatureCategories(EnumAsClass):
    CATEGORY_PHENOTYPIC = Coding(ontology=Ontologies.LOINC, code="81259-4", display=None)
    CATEGORY_CLINICAL = Coding(ontology=Ontologies.LOINC, code="75321-0", display=None)
