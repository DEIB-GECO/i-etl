...
from catalogue.ProfileComputation import ProfileComputation
    ...
    def run(self) -> None:
        ...
        for one_filename in all_filenames:
            ...
            if one_filename not in all_metadata[MetadataColumns.DATASET_NAME].unique():
                ...
                # compute the profiles of the features of the current dataset
                self.profile_computation = ProfileComputation(database=self.database, dataset_gid=current_dataset_instance.global_identifier)
