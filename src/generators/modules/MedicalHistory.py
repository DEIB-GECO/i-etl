...
class MedicalHistory:
    ...
    def generate_walk_age(field_name, walk_indep):
        return headfake.field.OperationField(name=field_name, operator=None, first_value=walk_indep, second_value=None,
                                             operator_fn=MedicalHistory.__generate_walk_age)
    ...
    def generate_speak_age(field_name, speak_indep):
        return headfake.field.OperationField(name=field_name, operator=None, first_value=speak_indep, second_value=None,
                                             operator_fn=MedicalHistory.__generate_speak_age)
...
class IDTest:
    ...
    def generate_ID_test_to_string(field_name, hasID):
        return headfake.field.OperationField(name=field_name, operator=None, first_value=hasID, second_value=None,
                                             operator_fn=IDTest.__generate_ID_test_to_string)
