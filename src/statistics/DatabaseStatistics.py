...
class DatabaseStatistics(Statistics):
    def __init__(self, record_stats: bool):
        ...
        self.cc_with_no_coding_per_table = {}
    ...
    def compute_nb_of_rec_with_no_value_per_instantiate(self, database: Database) -> None:
        ...
        for table_name in TableNames.records(db=database):
            instantiates_no_value = [res for res in database.find_distinct_operation(table_name=table_name, key="instantiate", filter={"value": {"$exists": 0}})]
