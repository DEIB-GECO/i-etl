...
BATCH_SIZE = 10000
MAX_FILE_SIZE = 10 * 1048576  # 10Mb = 10x 1024^2 (bytes) -- MongoDB is limited to 16Mo but our size estimate is usually lower than the real size so we stay at 10Mo to avoid creating files with a real size larger than 16Mo
